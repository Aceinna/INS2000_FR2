...
def configNovatel(ser):
    ...
    #'setimutoantoffset -0.2077 1.8782 1.0 0.10 0.10 0.10\r',\ #old antenna
    # 'setimutoantoffset 0.05 0.9144 0.02 0.05 0.05 0.05\r',\  # on the cart
    setupcommands  = ['unlogall\r',\
                'serialconfig com1 230400 N 8 1 N OFF\r',\
                'ETHCONFIG ETHA AUTO AUTO AUTO AUTO\r',\
                'NTRIPCONFIG ncom1 client v1 rtk.aceinna.com:2201 RTK_ITRF2014 xw WGZVWTHZFX7RFN0F\r',\
                ...
                'log vehiclebodyrotation once\r',\
                'saveconfig\r']
    for cmd in setupcommands:
        ser.write(cmd.encode())    
 

ser = serial.Serial('com140',230400,parity='N',bytesize=8,stopbits=1,timeout=None) #novatel
